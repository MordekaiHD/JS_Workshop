// import logo from './header/header__nav/header__nav__left/logo.svg';
  ...
  return (
    <header className="header">
      ...
      <div className="header__nav__right">
        ...
        <Link to='/registracion' href="#" class="header__nav__right__svg header__nav__right__svg_link"><svg width="29" height="29"
