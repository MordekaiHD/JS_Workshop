  ...
  return (
    <header className="header">
      <div className="header__nav__left">
        <Link to="/index" className="header__nav__left__link">
      ...
      <div className="header__nav__right">
        ...
        <a href="#" class="header__nav__right__svg header__nav__right__svg_link"><svg width="29" height="29"
        ...
        <a href="#" class="header__nav__right__svg header__nav__right__svg_link"><svg width="32" height="29"
