...
function ProductsDescription() {
  ...
  return (
    <div className="products__description">
      <h1 className="products__description__top__title">WOMEN COLLECTION</h1>
      <hr className="products__description__line__top" />

      <h2 className="products__description__title">{product.title}</h2>
      <p className="products__description__text">{product.description}</p>
      <p className="products__description__price">${product.price.toFixed(2)}</p>
      <hr className="products__description__line" />

      <div className="products__description__filter">
        <details className="products__description__details" open >
          <summary className="products__description__summary">
            CHOOSE COLOR
            <svg width="10.02" height="5.05" viewBox="0 0 10.02 5.04614" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <div className="products__description__options__color">
        ...
        <details className="products__description__details" open >
          ...
          <div className="products__description__options__size ">
            <label className="color-option">
              <input
                type="radio"
                value="S"
        ...
        <details className="products__description__details" open >
          ...
          <div className="products__description__options__quantity">
            <input className='products__description__quantity'
              type="number"
              min="1"
      ...
      <div className="products__description__add">
        <button className="products__description__button" onClick={handleAddToCart} >
          <svg width="26.01" height="24.2" viewBox="0 0 26.01 24.2" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
