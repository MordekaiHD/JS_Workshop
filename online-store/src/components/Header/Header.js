  ...
  return (
    <header className="header">
      <div className="header__nav__left">
        <Link to="/" className="header__nav__left__link">
          <img src="/ImgHeader/header__nav__left/logo.svg" alt="logo" />
        </Link>
        <a href="#" className="header__nav__left__link">
      ...
      <div className="header__nav__right">
        ...
        <label htmlFor="checkbox">
          <span className="header__nav__right__svg">
        ...
        <div className="header__menu">
          ...
          <div className="header__man">
            <h3 className="header__man__subtitle">MAN</h3>
            <ul className="header__man__ul">
              <li className="header__man__li"><a className="header__man__link" href="#">Accessories</a></li>
              <li className="header__man__li"><a className="header__man__link" href="#">Bags</a></li>
              <li className="header__man__li"><a className="header__man__link" href="#">Denim</a></li>
              <li className="header__man__li"><a className="header__man__link" href="#">T-Shirts</a></li>
            </ul>
          </div>
          <div className="header__man">
            <h3 className="header__man__subtitle">WOMAN</h3>
            <ul className="header__man__ul">
              <li className="header__man__li"><a className="header__man__link" href="#">Accessories</a></li>
              <li className="header__man__li"><a className="header__man__link" href="#">Bags</a></li>
              <li className="header__man__li"><a className="header__man__link" href="#">Denim</a></li>
          ...
          <div className="header__man">
            <h3 className="header__man__subtitle">KIDS</h3>
            <ul className="header__man__ul">
              <li className="header__man__li"><a className="header__man__link" href="#">Accessories</a></li>
              <li className="header__man__li"><a className="header__man__link" href="#">Bags</a></li>
              <li className="header__man__li"><a className="header__man__link" href="#">Denim</a></li>
        ...
        <Link to='/registracion' href="#" className="header__nav__right__svg header__nav__right__svg_link"><svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Link to='/cart' href="#" class="header__nav__right__svg header__nav__right__svg_link"><svg width="32" height="29"
